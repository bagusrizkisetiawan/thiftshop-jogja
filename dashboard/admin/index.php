      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item <?php if($page=='user' || $page=='tambah_user'){echo'active';} ?>">
            ...
            <li class="menu-item <?php if($page=='kategori' || $page=='edit_kategori'){echo'active';} ?>">
            ...
            <li class="menu-item <?php if($page=='produk' || $page=='deskripsi'){echo'active';} ?>">
              <a href="?page=produk" class="menu-link">
                <i class="menu-icon tf-icons bx bx-cart"></i>
                <div data-i18n="Account Settings">produk</div>
              </a>
            </li>
            <li class="menu-item <?php if($page=='komentar'){echo'active';} ?>">
              <a href="?page=komentar" class="menu-link">
                <i class="menu-icon tf-icons bx bx-comment"></i>
                <div data-i18n="Account Settings">komentar</div>
              </a>
            </li>
          </ul>
        </aside>
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                  ...
                  <?php
                    ...
                    elseif ($page=='user') {
                        echo"<li class='breadcrumb-item active'><a href=''>User</a></li>";
                    }
                    ...
                    elseif ($page=='tambah_user') {
                      echo"<li class='breadcrumb-item'><a href='?page=user'>User</a></li>";
                      echo"<li class='breadcrumb-item active'><a href=''>Tambah User</a></li>";
                    }
                  ?>
