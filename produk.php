    ...
    <div class="bg-primary text-white">  
        <div class="container py-3">
            <div class="py-5 text-center">
                <h4 class="text-white">ThriftShop-Jogja</h4>
                <p class="">Jelajahi produk yang ada di ThriftShop-Jogja dan dapatkan barang impianmu secara mudah </p>
            </div>
        </div>
    </div>
</div>
...
<div class="container mb-3 mt-3">
    <div class="btn-group">
        <a href="#" class="btn btn-primary active mb-3 mt-2" data-bs-toggle="modal" data-bs-target="#pilih_kategori"><i class="fa-solid fa-list"></i></a>
        <a href="#" class="btn btn-primary mb-3 mt-2" data-bs-toggle="modal" data-bs-target="#pilih_kategori">Pilih Kategori Produk</a>
    </div>
    ...
    <div class="row mt-2">
        <?php
            ...
            if(!empty($pecarian)){
                ...
                $cek_pencarian=mysqli_num_rows($q);
                if (empty($cek_pencarian)) {
                    echo "<div class='alert alert-secondary m-2'>Produk yang anda cari tidak tersedia</div>";
                }
            }else{
                $q=mysqli_query($koneksi, "SELECT * FROM produk a LEFT JOIN user b ON a.id_user=b.id_user WHERE tinjauan='disetujui' order by id_produk DESC");
            }
